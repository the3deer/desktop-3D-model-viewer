...
package org.andresoviedo.app.modelviewer3D.loaders.obj.OBJLoaderGL;
...
public class Faces {
	...
	/*
	 * get this face's indicies from line "f v/vt/vn ..." with vt or vn index
	 * values perhaps being absent.
	 */
	{
		try {
	...
	/*
	 * A face token (v/vt/vn) may be missing vt or vn index values; add 0's in
	 * those cases.
	 */
	{
	...
	/*
	 * Render the ith face by getting the vertex, normal, and tex coord indicies
	 * for face i. Use those indicies to access the actual vertex, normal, and
	 * tex coord data, and render the face.
	 * 
	 * Each face uses 3 array of indicies; one for the vertex indicies, one for
	 * the normal indicies, and one for the tex coord indicies.
	 * 
	 * If the model doesn't use normals or tex coords then the indicies arrays
	 * will contain 0's.
	 * 
	 ...
	 */
	{
		...
		/*
		 * render the normals, tex coords, and vertices for face i by accessing
		 * them using their indicies
		 */
