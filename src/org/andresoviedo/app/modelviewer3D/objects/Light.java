package org.andresoviedo.app.modelviewer3D.objects;
...
public class Light {
	...
	static {
		LIGHT_NAMES.put(GL.GL_LIGHT0, "GL_LIGHT0");
		LIGHT_NAMES.put(GL.GL_LIGHT1, "GL_LIGHT1");
		LIGHT_NAMES.put(GL.GL_LIGHT2, "GL_LIGHT2");
		LIGHT_NAMES.put(GL.GL_LIGHT3, "GL_LIGHT3");
		LIGHT_NAMES.put(GL.GL_LIGHT4, "GL_LIGHT4");
		LIGHT_NAMES.put(GL.GL_LIGHT5, "GL_LIGHT5");
		LIGHT_NAMES.put(GL.GL_LIGHT6, "GL_LIGHT6");
		LIGHT_NAMES.put(GL.GL_LIGHT7, "GL_LIGHT7");
	}
